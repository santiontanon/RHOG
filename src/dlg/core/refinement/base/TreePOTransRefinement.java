 ...
 * @author santi
 * 
 * This refinement operator is an extended version of "TreePORefinement":
 ...
 * 
 */
public class TreePOTransRefinement extends RefinementOperator implements IncrementalRefinementOperator {
    ...
    TreePORefinement m_po_rho = null;
    ...
    public TreePOTransRefinement(PartialOrder po) {
        vertexTopLabels.add(po.getTop());
        edgeTopLabels.add(po.getTop());
        partialOrder = po;
        
        m_po_rho = new TreePORefinement(po);
    }


    public TreePOTransRefinement(List<Label> rl, List<Label> el, PartialOrder po) {
        vertexTopLabels.addAll(rl);
        edgeTopLabels.addAll(el);
        partialOrder = po;
        
        m_po_rho = new TreePORefinement(rl, el, po);
    }
