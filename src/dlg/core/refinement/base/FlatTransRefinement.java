 ...
 * @author santi
 * 
 * This refinement operator is an extended version of "FlatRefinement":
 ...
 * 
 */
public class FlatTransRefinement extends RefinementOperatorUsingFlatLabels implements IncrementalRefinementOperator {
    ...
    FlatRefinement m_flat_rho = null;
    ...
    public FlatTransRefinement(List<Label> rl, List<Label> el) {
        super(rl,el);
        
        m_flat_rho = new FlatRefinement(rl, el);
    }
